...
public void mirrorGull()
{
                 ...
                 int startRow, int startCol)
  {
   ...
   public void copy(Picture fromPic,
                   int startRow,int endRow, int startCol, int endCol)
    {
      ...
      Pixel[][] toPixels = this.getPixels2D();
      Pixel[][] fromPixels = fromPic.getPixels2D();
      for (int fromRow = startRow,row=0, toRow = endRow;
           fromRow < fromPixels.length &&
           toRow < toPixels.length;
           fromRow++, row++)
      {
        for (int fromCol = startCol,col=0, toCol = endCol;
             fromCol < fromPixels[0].length &&
             toCol < toPixels[0].length;
             fromCol++, col++)
        {
  ...
  public void myCollage()
  {
    ...
    Picture flowerKeepBlue = new Picture(flower1);
    Picture flowerGrayscale = new Picture(flower3);
    flowerKeepBlue.KeepOnlyBlue();
    flowerNegate.negate();
    flowerGrayscale.grayscale();
    this.copy(flowerNegate,300,0);
    this.copy(flowerKeepBlue,400,0);
    this.copy(flowerGrayscale,400,200);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
